...
You can find an example project that uses Docsy in the [Docsy Example Project repo](https://github.com/historcn/historic). The Docsy Example Project is hosted at [https://example.docsy.dev/](https://example.docsy.dev/).

To use the Docsy theme for your own site:

  - (Recommended) Copy the [example project](https://github.com/historcn/historic),
￼	   which includes the Docsy theme as a submodule.
    ...
    [Learn more...](https://github.com/historcn/historic)
